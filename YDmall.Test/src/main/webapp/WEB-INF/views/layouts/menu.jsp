				...
				<div class="row h-100">
					<div class="col-12 d-md-flex justify-content-between">
							...
							<nav class="navbar navbar-expand-lg align-items-start">
								...
								<div class="collapse navbar-collapse align-items-start collapse"
									...
									<ul class="navbar-nav animated" id="nav">
										...
										<li class="nav-item dropdown"><a
											class="nav-link dropdown-toggle" href="memberEditForm.yd"
											id="karlDropdown" role="button" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false">MyPage</a>
											<div class="dropdown-menu" aria-labelledby="karlDropdown">
												<a class="dropdown-item" href="memberEdit.yd">내 정보수정</a> <a
													class="dropdown-item" href="memberOrder.yd">주문 조회</a> <a
													class="dropdown-item" href="memberOrderHistory.yd">구매
												내역</a> <a class="dropdown-item" href="memberDelete.yd">회원탈퇴</a>
											</div></li>
									</ul>
								</div>
							</nav>
						...
						<!-- Help Line -->
							...
							<a href="login.yd" id="login_logout">Login</a> <a
								href="signUp.yd">Sign Up</a>
						</div>
					</div>
				</div>
			</div>
